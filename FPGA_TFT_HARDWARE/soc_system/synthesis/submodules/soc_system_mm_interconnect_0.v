...
module soc_system_mm_interconnect_0 (
	...
	wire  [100:0] onchip_memory2_1_s1_agent_rf_source_data;                                   // onchip_memory2_1_s1_agent:rf_source_data -> onchip_memory2_1_s1_agent_rsp_fifo:in_data
	...
	wire  [100:0] onchip_memory2_1_s1_agent_rsp_fifo_out_data;                                // onchip_memory2_1_s1_agent_rsp_fifo:out_data -> onchip_memory2_1_s1_agent:rf_sink_data
	...
	wire  [126:0] sysid_qsys_control_slave_agent_rp_data;                                     // sysid_qsys_control_slave_agent:rp_data -> router_004:sink_data
	...
	wire   [99:0] onchip_memory2_1_s1_agent_rp_data;                                          // onchip_memory2_1_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [126:0] cmd_mux_001_src_data;                                                       // cmd_mux_001:src_data -> sysid_qsys_control_slave_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                                      // sysid_qsys_control_slave_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [4:0] cmd_mux_001_src_channel;                                                    // cmd_mux_001:src_channel -> sysid_qsys_control_slave_burst_adapter:sink0_channel
	...
	wire   [99:0] onchip_memory2_0_s1_burst_adapter_source0_data;                             // onchip_memory2_0_s1_burst_adapter:source0_data -> onchip_memory2_0_s1_agent:cp_data
	...
	wire   [99:0] onchip_memory2_1_s1_burst_adapter_source0_data;                             // onchip_memory2_1_s1_burst_adapter:source0_data -> onchip_memory2_1_s1_agent:cp_data
	...
	wire    [4:0] onchip_memory2_1_s1_burst_adapter_source0_channel;                          // onchip_memory2_1_s1_burst_adapter:source0_channel -> onchip_memory2_1_s1_agent:cp_channel
	...
	wire   [99:0] router_005_src_data;                                                        // router_005:src_data -> onchip_memory2_0_s1_rsp_width_adapter:in_data
	...
	wire  [126:0] onchip_memory2_0_s1_rsp_width_adapter_src_data;                             // onchip_memory2_0_s1_rsp_width_adapter:out_data -> rsp_demux_002:sink_data
	...
	wire          router_006_src_valid;                                                       // router_006:src_valid -> onchip_memory2_1_s1_rsp_width_adapter:in_valid
	wire   [99:0] router_006_src_data;                                                        // router_006:src_data -> onchip_memory2_1_s1_rsp_width_adapter:in_data
	wire          router_006_src_ready;                                                       // onchip_memory2_1_s1_rsp_width_adapter:in_ready -> router_006:src_ready
	wire    [4:0] router_006_src_channel;                                                     // router_006:src_channel -> onchip_memory2_1_s1_rsp_width_adapter:in_channel
	wire          router_006_src_startofpacket;                                               // router_006:src_startofpacket -> onchip_memory2_1_s1_rsp_width_adapter:in_startofpacket
	wire          router_006_src_endofpacket;                                                 // router_006:src_endofpacket -> onchip_memory2_1_s1_rsp_width_adapter:in_endofpacket
	...
	wire  [126:0] onchip_memory2_1_s1_rsp_width_adapter_src_data;                             // onchip_memory2_1_s1_rsp_width_adapter:out_data -> rsp_demux_003:sink_data
	...
	wire    [4:0] onchip_memory2_1_s1_rsp_width_adapter_src_channel;                          // onchip_memory2_1_s1_rsp_width_adapter:out_channel -> rsp_demux_003:sink_channel
	...
	wire  [126:0] cmd_mux_002_src_data;                                                       // cmd_mux_002:src_data -> onchip_memory2_0_s1_cmd_width_adapter:in_data
	...
	wire   [99:0] onchip_memory2_0_s1_cmd_width_adapter_src_data;                             // onchip_memory2_0_s1_cmd_width_adapter:out_data -> onchip_memory2_0_s1_burst_adapter:sink0_data
	...
	wire  [126:0] cmd_mux_003_src_data;                                                       // cmd_mux_003:src_data -> onchip_memory2_1_s1_cmd_width_adapter:in_data
	wire          cmd_mux_003_src_ready;                                                      // onchip_memory2_1_s1_cmd_width_adapter:in_ready -> cmd_mux_003:src_ready
	wire    [4:0] cmd_mux_003_src_channel;                                                    // cmd_mux_003:src_channel -> onchip_memory2_1_s1_cmd_width_adapter:in_channel
	...
	wire   [99:0] onchip_memory2_1_s1_cmd_width_adapter_src_data;                             // onchip_memory2_1_s1_cmd_width_adapter:out_data -> onchip_memory2_1_s1_burst_adapter:sink0_data
	...
	wire    [4:0] onchip_memory2_1_s1_cmd_width_adapter_src_channel;                          // onchip_memory2_1_s1_cmd_width_adapter:out_channel -> onchip_memory2_1_s1_burst_adapter:sink0_channel
	...
	wire    [9:0] onchip_memory2_0_s1_agent_rdata_fifo_out_data;                              // onchip_memory2_0_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_002:in_0_data
	...
	wire    [9:0] avalon_st_adapter_002_out_0_data;                                           // avalon_st_adapter_002:out_0_data -> onchip_memory2_0_s1_agent:rdata_fifo_sink_data
	...
	wire          onchip_memory2_1_s1_agent_rdata_fifo_out_valid;                             // onchip_memory2_1_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_003:in_0_valid
	wire    [9:0] onchip_memory2_1_s1_agent_rdata_fifo_out_data;                              // onchip_memory2_1_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_003:in_0_data
	wire          onchip_memory2_1_s1_agent_rdata_fifo_out_ready;                             // avalon_st_adapter_003:in_0_ready -> onchip_memory2_1_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_003_out_0_valid;                                          // avalon_st_adapter_003:out_0_valid -> onchip_memory2_1_s1_agent:rdata_fifo_sink_valid
	wire    [9:0] avalon_st_adapter_003_out_0_data;                                           // avalon_st_adapter_003:out_0_data -> onchip_memory2_1_s1_agent:rdata_fifo_sink_data
